...
*/
	...
	;
            ...
            function onFilesAdded(up, files, self) {
                let file = files[0];
                ...
                if (!plupload.isEmptyObj(up.settings.resize) && runtimeCan(blob, 'send_binary_string') && plupload.inArray(blob.type, ['image/jpeg', 'image/png']) !== -1) {
                    ...
                    resizeImage.call(this, blob, up.settings.resize, function(resizedBlob) {
                        baseResizedBlob = resizedBlob;
                        blob = resizedBlob;
                        files[0].size = resizedBlob.size;
            ...
            function bindEventListeners() {
                ...
                this.bind('FilesAdded2', onFilesAdded);
            ...
            function setOption(option, value, init) {
                ...
                function _setOption(option, value, init) {
                    ...
                    case 'chunk_size':
                        value = plupload.parseSize(value);
                        if (value >= 0) {
		...
		// make sure we start at a predictable offset
                ...
                function uploadNextChunk() {
                    ...
                    var type = up.settings.type || 'post';
                ...
                if (!plupload.isEmptyObj(up.settings.resize) && runtimeCan(blob, 'send_binary_string') && plupload.inArray(blob.type, ['image/jpeg', 'image/png']) !== -1) {
                    // Resize if required
                    if (baseResizedBlob) {
                        blob = baseResizedBlob;
                        file.size = baseResizedBlob.size;
                        uploadNextChunk();
                    } else {
                        resizeImage.call(this, blob, up.settings.resize, function(resizedBlob) {
                            blob = resizedBlob;
                    ...
                    if (queue.length) {
                        plupload.inSeries(queue, function() {
                            ...
                            if (filesAdded.length) {
                                self.trigger('FilesAdded2', filesAdded, self);
